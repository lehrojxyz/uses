...
- [DisplayLink Manager](https://synaptics.com/products/displaylink-graphics)
- [IINA](https://iina.io)
...
<br>
The theme I use is [Catppucin Mocha](https://marketplace.visualstudio.com/items?itemName=catppuccin.catppuccin-vsc) with the font [Geist](https://github.com/vercel/geist-font).
...
- [Composer Intelephense](https://marketplace.visualstudio.com/items?itemName=muath-ye.composer-intelephense)
...
- Theme: Catppuccin Mocha (Ghostty built-in)
